    ...
    return(
      <>
        ...
        <div className="postingWrap">
          <Posting writer={"뽕뽕이"} date={"2021-04-21"} time={"13:28:23"} content={"내용 길어지면 어떻게 자르지 내용 길어지면 어떻게 자르지 내용 길어지면 어떻게 자르지 내용 길어지면 어떻게 자르지 내용 길어지면 어떻게 자르지 내용 길어지면 어떻게 자르지내용 길어지면 어떻게 자르지"} comments={"3"}></Posting>
          <Posting></Posting>
          <Posting></Posting>
          <Posting></Posting>
          <Posting></Posting>
